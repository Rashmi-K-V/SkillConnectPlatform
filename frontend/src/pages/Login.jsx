...
function Login() {
  ...
  // ✅ Fix 1: always start with empty fields — never pre-filled
  useEffect(() => {
    setEmail("");
    setPassword("");
  }, []);
  ...
  // ✅ Fix 9: translate page UI using Google Translate widget
  // This is done via LanguageContext — all t() calls use the selected lang
    ...
    <>
      <style>{`
        ...
        *,*::before,*::after{box-sizing:border-box;margin:0;padding:0;}
        .lg-root{font-family:'Manrope','Segoe UI',sans-serif;min-height:100vh;width:100%;background:#0d0d0d;display:flex;align-items:center;justify-content:center;padding:24px 16px;position:relative;overflow:hidden;}
        ...
        @media(max-width:480px){.lg-card{padding:30px 22px 28px;border-radius:20px;}.lg-heading{font-size:22px;}.lg-register{flex-direction:column;align-items:flex-start;}.lg-register-btn{width:100%;text-align:center;}}
      `}</style>
            ...
            <>
              ...
              <div className="lg-field">
                ...
                <div className="lg-input-wrap">
                  {/* ✅ autoComplete="off" prevents browser from filling email */}
                  <input
                    className="lg-input"
                    type="email"
                    placeholder={t("email")}
              ...
              <div className="lg-register">
                <div className="lg-register-text">
                  <strong>{t("dont have account?")}</strong>Create one in
                  seconds.
                </div>
                <button
